                ...
                foreach ($order as $value){
                    ...
                    echo '      <ul class="list-group">';
                            foreach ($productList as $item){
                                ...
                                echo '<il class="mb-1 items"><span class="item_name text-primary">•&nbsp'.$item_name.':&nbsp'.'</span>'.$currency.'$<span class="item_value">'.$item_price."*".$item_quantity.'</span>&nbspunits</il>';
                            }
                    echo '      </ul>';
                    echo'   </td>';
