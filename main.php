...
foreach ($p_res as $value){
    ...
    $product .= '        <a href="?pid='.$value["PID"].'" class="product_detail_button">';
    ...
    $product .= '               <h5 class="product_detail_button card-title col-8"><a href="?pid='.$value["PID"].'" id="titleP-'.$value["PID"].'">'.$value["PRODUCT_NAME"].'</a></h5>';
